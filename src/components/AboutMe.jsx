  ...
  return (
    ...
    >
      ...
      <Wrapper>
        ...
        <Div className="max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] mb-[20px] md:mb-[30px] 2xl:mb-[50px] relative">
          Experience: <br />
          Freelancing - Upwork, Fiverr <br />◦ I am a freelancer specializing in
          developing full stack websites, providing end-to-end solutions for
        ...
        <Div className="max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] relative">
          Internship : <br />
          • QnA SDE Intern <br />
          ◦ Responsive Web Design: frontend and backend development for a
          responsive webpage.
          <br />◦ Verification Solutions: Designed user
          verification/authentication processes and tackled challenges in
          detecting and eliminating fake bots and posts
        </Div>
        {/* PARAGRAPH END */}
      </Wrapper>
    </div>
